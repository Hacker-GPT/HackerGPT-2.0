      ...
      {isListening ? (
        ...
        >
          ...
          <TextareaAutosize
            ...
            className={`ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring text-md bg-primary-foreground flex w-full resize-none rounded-md border-none py-2 pl-4 ${
              isMicSupported &&
              hasSupportedMimeType &&
              !userInput &&
              !isGenerating
